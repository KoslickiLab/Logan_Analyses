...
python create_dmi_database.py \
        --source /scratch/shared_data_new/Logan_yacht_data/processed_data/database_all.db \
        --samples /scratch/dmk333_new/Logan/Logan_Analyses/verify_diversity_correlation/data/hash_diversity_results_full_cov_0.0/data/hash_diversity_data.parquet \
        --reference /scratch/dmk333_new/Logan/Logan_Analyses/dark_matter_index/data_orig/reference_hashes_k31.bin \
        --output /scratch/dmk333_new/Logan/Logan_Analyses/dark_matter_index/data/samples_with_reference_hashes_cov_0.0_min_mbases_100.db \
        --ksize 31 #\
	#--skip-reference \
	#--skip-samples
